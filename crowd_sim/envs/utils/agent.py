...
class Agent(object):
    ...
    def sample_random_attributes(self):
        ...
        :return:
        """
        self.v_pref = np.random.choice([3.0, 3.5, 4.0, 4.5, 5.0, 5.56])#np.random.uniform(5.0, 5.56)
        #self.radius = np.random.uniform(0.3, 0.5)
        self.radius = 0.5#np.random.choice([0.9, 1.0, 1.1, 1.2])
    ...
    def step(self, action):#, g_x, g_y):
        ...
        #self.set_goal_position((g_x, g_y))
